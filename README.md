...
### [READ](https://github.com/felipefacundes/dicas/blob/master/README.md)! First: install due dependencies. Boost performance with +50+ FPS - enable Esync. Click [aqui](https://github.com/felipefacundes/dicas/blob/master/README.md) for [ler](https://github.com/felipefacundes/dicas/blob/master/README.md) more.
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/Origin.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
```
#
### Steam Windows for Windows Games via Steam
#### With DXVK Support - Check out the tutorial on Youtube first:
###### Click on the picture ▼↓below↓▼ to access the YouTube tutorial:
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/steam.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
```
#
### Steam Light Windows for Windows Games via Steam (OpenGL)
#### Check out the tutorial on Youtube first:
###### Click on the picture ▼↓below↓▼ to access the YouTube tutorial:
[![Steam](https://raw.githubusercontent.com/felipefacundes/PS/master/imagens/steam.gif)](https://github.com/felipefacundes/dicas/blob/master/TutoConstruction.md)
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/steam-light.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/spore.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/gtasamta.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
#### Check out the tutorial on Youtube first:
###### Click on the picture ▼↓below↓▼ to access the YouTube tutorial:
[![FlatOut2](https://raw.githubusercontent.com/felipefacundes/PS/master/imagens/flatout2.gif)](https://github.com/felipefacundes/dicas/blob/master/TutoConstruction.md)
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/flatout2.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install manually, but first change the path of the game installer:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/TheSims4.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
```
#
### Age Of Empires III - Rev. 06/26//2019
#### Check out the tutorial on Youtube first:
###### Click on the picture ▼↓below↓▼ to access the YouTube tutorial:
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/ageofempiresIII.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/opensonic.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/VictoriaII.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/cs16.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/yuzu.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/CEMU.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/PCSX2.sh)`
###### Optional for anyone who wants to make changes:
```bash
...
##### Install Automatically:
`bash <(curl -s https://raw.githubusercontent.com/felipefacundes/PS-en/master/PS1.sh)`
###### Optional for anyone who wants to make changes:
```bash
